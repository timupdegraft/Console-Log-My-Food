    ...
    switch (line.trim()) {
        ...
        case 'log' :
                        ...
                        readline.question(
                            ...
                            servingSize => {
                                if (servingSize === 'nevermind' || servingSize === 'n') {
                                    actionIt.return();
                                } else if (typeof Number(servingSize) !== 'number' || servingSize === NaN) {
                    ...
                    async function displayCalories(servingSize, food) {
                        ...
                        console.log(`${food.name} with a serving size of ${servingSize} has ${Number.parseFloat( calories * parseInt(servingSize, 10)).
                            toFixed()} calories. `,
                        );
